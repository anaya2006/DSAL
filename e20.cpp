...
int main() {
	...
	do {
	cout << "1 to Insert the Data in Queue" << endl << "2 to show the Data in Queue " << endl << "3 to Delete the data from the Queue" 
		<< endl << "0 to Exit"<< endl;
	cin >> opt;
		switch(opt) {
			case 1:
				...
				while(i < n) {
					...
					cin >> data;
					ifnotdoagain: 
						cout << "Enter Priorities (0: serious, 1: non-serious, 2: general checkup) : ";
						cin >> p;
						switch(p) {
							case 0: 
