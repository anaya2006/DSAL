...
void dictionary::descending(avlnode *root)  //reverse inorder
{
	if(root)
	{
...
//	else
//	{
		avlnode *a,*pa,*p,*pp;  //a last unbalanced ancestor and  p is traversal pointer
		//a=NULL;
		pa=NULL;
		p=a=root;
		pp=NULL;
		...
		if(!(a->bf)||!(a->bf+d))   //true if a->bf/+d==0
		{
			a->bf+=d;
			return;
		}
...
C:\Users\HP\Desktop\DSAL>g++ d19.cpp
